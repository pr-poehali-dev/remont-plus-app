    ...
    <>
      ...
      <div className="page">
        ...
        <div className="section">
          ...
          <ol>
            <li>Договор заключается на неопределённый срок с даты подписания и действует бессрочно до момента его расторжения одной из Сторон в порядке, предусмотренном настоящим договором.</li>
