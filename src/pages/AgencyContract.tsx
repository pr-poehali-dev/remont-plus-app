    ...
    <>
      ...
      <div className="page">
        ...
        <div className="section">
          ...
          <ol>
            <li>Договор заключается на срок 1 (один) год с даты подписания и автоматически пролонгируется на тот же срок при отсутствии возражений Сторон.</li>
            <li>Каждая из Сторон вправе расторгнуть договор в одностороннем порядке, направив письменное уведомление за 30 (тридцать) календарных дней.</li>
