...
const exampleProjects: ExampleProject[] = [
  {
    ...
    images: [
      { src: `${CDN}/f88f632e-0c35-4529-a23f-f52566284ed5.jpg`, label: "Общий вид" },
      { src: `${CDN}/16e555dc-a476-40ff-ae5c-7b157607113c.jpg`, label: "Планировка" },
      { src: `${CDN}/c2d40848-a52f-4fd5-bc91-c6e2d603725a.jpg`, label: "Чертёж" },
      { src: `${CDN}/68e0468f-b3f7-474f-a153-ea618b47d70e.jpg`, label: "Гостиная" },
      { src: `${CDN}/9b6b4808-eab8-41d8-9ef9-f9a11604c813.jpg`, label: "Спальня" },
      { src: `${CDN}/0b93d17c-d851-49a1-82a4-8bbe1339a747.jpg`, label: "Кухня" },
    ],
  },
  {
    id: "loft",
    ...
    images: [
      { src: `${CDN}/088f9541-7e31-494e-9fb4-d0d01f535db6.jpg`, label: "Гостиная" },
      { src: `${CDN}/36282149-5af0-4de2-b25b-28492c93b895.jpg`, label: "Планировка" },
      { src: `${CDN}/587cca2c-8dde-4e1e-ba65-638a8231a9a0.jpg`, label: "Кухня" },
      { src: `${CDN}/57092d1b-ffd5-4a59-a3a9-e2254787e6db.jpg`, label: "Спальня" },
      { src: `${CDN}/7b5d3f50-fcfc-42ce-8890-beae9349af6f.jpg`, label: "Ванная" },
    ],
  },
  {
    id: "scandi",
    ...
    images: [
      { src: `${CDN}/a8bdd669-5922-4256-9c8c-a505a56c330a.jpg`, label: "Гостиная" },
      { src: `${CDN}/b6efee95-3c72-4e2b-a6f4-60d066a4db13.jpg`, label: "Планировка" },
      { src: `${CDN}/c601e132-5dc6-455e-9dd0-1aff42d9a1d6.jpg`, label: "Кухня" },
      { src: `${CDN}/1134bc5d-426e-4535-a0f3-452f6b65e76d.jpg`, label: "Спальня" },
      { src: `${CDN}/cd839290-6d42-4031-bfd0-126cde3c9186.jpg`, label: "Ванная" },
    ],
  },
];
