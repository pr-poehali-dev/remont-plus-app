...
export default function Tariffs() {
  ...
  useMeta({
    ...
    description: "Тарифы АВАНГАРД: дизайн-проект, смета, ИИ-эксперт по интерьеру, органайзер ремонта, голосовой ассистент ЯСЕН, шоурум готовых проектов. Для частных клиентов и строительных компаний.",
