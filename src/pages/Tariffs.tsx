...
export default function Tariffs() {
  ...
  useMeta({
    ...
    keywords: "цены смета ремонт, стоимость сметы, КС-2 КС-3, тарифы строительная компания, B2B автоматизация смет, смета на ремонт цена",
    canonical: "/tariffs",
  });
      ...
      <main className="container mx-auto px-4 py-6 max-w-6xl">
        ...
        <div className="mb-10">
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold mb-2">Тарифы на сметы и документацию</h1>
              <p className="text-gray-500">
                Для частных клиентов — разовые пакеты, для строительных компаний — подписки с полным набором инструментов
              </p>
            </div>
            <Button
