...
export default function Expert() {
  useMeta({
    title: "Эксперт по дизайну и ремонту — бесплатная консультация",
    description: "ИИ-консультант АВАНГАРД ответит на любой вопрос по дизайну интерьера, выбору материалов и ремонту. Бесплатно, без регистрации.",
  });
