...
const CONDITIONS = [
  { icon: "Gift", title: "Бесплатный старт", text: "Регистрация и размещение профиля — бесплатно. Платите только за реальные результаты, когда начинаете расти." },
  { icon: "MapPin", title: "Только ваш регион", text: "Заявки приходят от клиентов из вашего города и области. Никакой конкуренции с компаниями из других регионов." },
  { icon: "Target", title: "Горячие клиенты", text: "Человек уже посчитал смету или дизайн-проект — он знает бюджет и готов к диалогу. Не нужно убеждать с нуля." },
        ...
        <div className="relative container mx-auto px-4 py-6">
          ...
          <div className="max-w-3xl mx-auto text-center pb-16 pt-4">
            ...
            <p className="text-white/50 text-lg leading-relaxed max-w-2xl mx-auto">
              ...
              Вы получаете тёплый контакт с чётким бюджетом — без холодных звонков и уговоров.
            </p>
