...
export const CABLING_TYPES: CablingType[] = [
  { id: "open",        label: "Открытая проводка",       description: "Кабель-канал / ретро",     pricePerM: 340 },
  { id: "corrugated",  label: "В гофре / трубе",         description: "Поверх стен в гофре",      pricePerM: 470 },
  { id: "hidden",      label: "Скрытая (в штробах)",     description: "Штробление + шпаклёвка",   pricePerM: 780 },
];
