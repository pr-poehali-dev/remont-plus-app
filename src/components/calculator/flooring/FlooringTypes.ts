...
export const SUBSTRATE_OPTIONS: SubstrateOption[] = [
  ...
  { id: "foam-3",    name: "Вспененная 3 мм",      pricePerM2: 45,  description: "Базовая, для ровных полов" },
  { id: "xps-3",     name: "XPS 3 мм",             pricePerM2: 65,  description: "Теплоизоляция + шумоизоляция" },
  { id: "xps-5",     name: "XPS 5 мм",             pricePerM2: 95,  description: "Повышенная теплоизоляция" },
  { id: "cork-2",    name: "Пробковая 2 мм",       pricePerM2: 110, description: "Премиум, гипоаллергенная" },
  { id: "thermo",    name: "Тёплый пол (подложка)", pricePerM2: 85,  description: "Совместима с тёплым полом" },
];
...
export const SKIRTING_OPTIONS: SkirtingOption[] = [
  ...
  { id: "pvc-60",     name: "ПВХ плинтус 60 мм",     pricePerM: 120, description: "Эконом, под цвет пола" },
  { id: "mdf-60",     name: "МДФ плинтус 60 мм",     pricePerM: 220, description: "Стандарт, крашеный" },
  { id: "mdf-100",    name: "МДФ плинтус 100 мм",    pricePerM: 380, description: "Высокий, премиум вид" },
  { id: "solid-oak",  name: "Дубовый плинтус",       pricePerM: 650, description: "Натуральный дуб, к паркету" },
