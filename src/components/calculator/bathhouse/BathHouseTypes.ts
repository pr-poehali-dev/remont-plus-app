...
export const WALL_MATERIALS: Record<WallMaterial, { label: string; desc: string; pricePerM2: number; category: string }> = {
  timber_profiled:   { label: "Брус профилированный 150×150", desc: "Классика. Экологично, быстро, хорошая теплоёмкость", pricePerM2: 3150, category: "Дерево" },
  timber_glued:      { label: "Брус клеёный 150×150", desc: "Премиум. Не деформируется, не трескается, идеальная геометрия", pricePerM2: 7050, category: "Дерево" },
  log_rounded:       { label: "Бревно оцилиндрованное ∅200", desc: "Традиционный русский вид, хорошая теплоёмкость", pricePerM2: 3800, category: "Дерево" },
  log_hand:          { label: "Бревно ручной рубки ∅220+", desc: "Премиум-ручная работа, максимальная аутентичность", pricePerM2: 7040, category: "Дерево" },
