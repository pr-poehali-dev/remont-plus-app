      ...
      <div>
        ...
        <div className="grid sm:grid-cols-3 gap-4">
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200 p-6 flex flex-col">
            ...
            <Button variant="outline" className="w-full" onClick={scrollToForm}>Заказать смету</Button>
          </div>
          ...
          <div className="relative bg-white rounded-2xl border-2 border-blue-500 p-6 flex flex-col shadow-lg">
            ...
            <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white" onClick={scrollToForm}>Заказать пакет</Button>
          </div>
          ...
          <div className="relative bg-white rounded-2xl border border-gray-200 p-6 flex flex-col">
            ...
            <Button variant="outline" className="w-full border-purple-300 text-purple-700 hover:bg-purple-50" onClick={scrollToForm}>Заказать пакет</Button>
          </div>
        </div>
      </div>
