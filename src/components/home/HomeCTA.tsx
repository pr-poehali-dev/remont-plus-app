      ...
      <section className="mt-20 mb-4">
        <div className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-amber-400 via-orange-500 to-rose-500 p-10 md:p-14">
          ...
          <div className="relative text-center">
            <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-4">Узнайте стоимость за 2 минуты</h2>
            <p className="text-white/90 text-lg mb-8 max-w-xl mx-auto">Создайте дизайн-проект или рассчитайте смету — партнёры по вашему региону предложат конкретные условия. Бесплатно.</p>
