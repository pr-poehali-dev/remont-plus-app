...
const BENEFITS = [
  { icon: "Target", text: "Только целевые заявки — клиент уже знает, что хочет и сколько готов потратить" },
  { icon: "MapPin", text: "Заявки из вашего региона — не нужно конкурировать со всей страной" },
  { icon: "TrendingUp", text: "Прозрачная аналитика: конверсии, отзывы, рейтинг в каталоге" },
  { icon: "Zap", text: "Быстрый старт — профиль компании за 15 минут, первые заявки в тот же день" },
];
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-10">
            <div>
              ...
              <p className="text-gray-500 text-lg max-w-xl">
                Получайте готовые заявки от клиентов, которые уже рассчитали стоимость и знают, чего хотят.
                Никакого холодного поиска — только горячий интерес.
              </p>
            </div>
            <Button
              size="lg"
              onClick={() => navigate("/register?type=contractor")}
