          ...
          <div className="mt-8 flex justify-center animate-fade-in" style={{ animationDelay: "400ms" }}>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-white font-bold text-sm leading-none mb-0.5">ГОТОВЫЕ ДИЗАЙН-ПРОЕКТЫ</div>
                <div className="text-white/50 text-xs">46, 65 и 98 м² — со сметами, материалами и мебелью</div>
              </div>
              <Icon name="ChevronRight" className="h-4 w-4 text-amber-400 group-hover:translate-x-1 transition-transform ml-1" />
            </button>
          </div>

          {/* Stats bar */}
          <div className="mt-6 flex justify-center animate-fade-in" style={{ animationDelay: "500ms" }}>
