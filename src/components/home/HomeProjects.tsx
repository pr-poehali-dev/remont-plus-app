...
export default function HomeProjects({ region }: Props) {
  ...
  const features = [
    { icon: "Bot", title: "ИИ-дизайнер за минуты", text: "Создайте визуализацию интерьера и готовый дизайн-проект — без дизайнера и лишних встреч. Результат можно сразу передать партнёрам для расчёта.", color: "text-amber-500" },
    { icon: "HandshakeIcon", title: "Предложения от партнёров", text: "Разместите запрос — и получите конкретные предложения от проверенных партнёров по всей России: мастера, поставщики, оконные компании.", color: "text-blue-500" },
    { icon: "Calculator", title: "Точный расчёт стоимости", text: "Калькулятор формирует смету по вашему региону: работы, материалы, окна. Никаких приблизительных цифр — только понятные цифры.", color: "text-emerald-500" },
    { icon: "MapPin", title: "Вся Россия", text: "Сервис работает по всей России. Цены и партнёры определяются автоматически по вашему региону — без ручного поиска и переплат.", color: "text-violet-500" },
  ];

  const reviews = [
    { name: "Анна К.", text: "Калькулятор за пару минут показал реальную стоимость по нашему городу. Получила три предложения от партнёров и выбрала оптимальное — никаких сюрпризов по цене.", rating: 5, date: "Январь 2026", emoji: "👩" },
    { name: "Дмитрий П.", text: "Сделал дизайн-проект прямо в сервисе, показал подрядчику — и тот дал точную смету без лишних вопросов. Сэкономил кучу времени на согласованиях.", rating: 5, date: "Декабрь 2025", emoji: "👨" },
    { name: "Елена М.", text: "Рассчитала окна онлайн: выбрала профиль, стеклопакет — всё наглядно. Сравнила предложения двух партнёров и выбрала лучшее. Быстро и удобно!", rating: 5, date: "Февраль 2026", emoji: "👩" },
  ];
