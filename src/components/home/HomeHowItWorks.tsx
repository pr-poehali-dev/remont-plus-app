...
const STEPS = [
  {
    ...
    description: "Укажите тип помещения, площадь и перечень работ — калькулятор мгновенно сформирует детальную смету с ценами по вашему региону. Документ готов к печати.",
  ...
  },
  {
    ...
    description: "Настройте конструкцию окна: профиль, стеклопакет, ламинацию, фурнитуру. Цена пересчитывается в реальном времени с учётом вашего региона.",
    cta: "Рассчитать окна",
    ctaPath: "/windows",
    icon: "AppWindow",
