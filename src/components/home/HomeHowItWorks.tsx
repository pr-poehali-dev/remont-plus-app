...
const STEPS = [
  ...
  },
  {
    ...
    description: "Опишите задачу ИИ-консультанту — стиль, бюджет, сроки. Он уточнит детали и поможет сформулировать запрос для партнёров так, чтобы получить точные предложения.",
    cta: "Начать чат",
    ctaPath: "/ai-chat",
    icon: "MessageSquare",
  ...
  },
  {
    ...
    description: "ИИ-дизайнер создаёт планировку и визуализацию интерьера за минуты. Вы видите результат до начала работ и можете сразу показать его партнёрам для точного расчёта.",
    cta: "Создать проект",
    ctaPath: "/designer",
    icon: "Palette",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 text-lg max-w-xl mx-auto">
            От идеи до готового расчёта — за несколько минут, без лишних звонков и встреч
          </p>
        </div>
