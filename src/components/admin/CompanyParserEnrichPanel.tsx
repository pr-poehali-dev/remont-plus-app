...
interface Props {
  ...
  rebuildMsg: string;
  statusMsg: string;
  enrichStopRef: MutableRefObject<boolean>;
  websiteStopRef: MutableRefObject<boolean>;
  rebuildStopRef: MutableRefObject<boolean>;
  onParse: () => void;
  onEnrichStart: () => void;
  onEnrichStop: () => void;
  onFindWebsites: () => void;
...
export default function CompanyParserEnrichPanel({
  cities,
  selectedCity,
  onCityChange,
  parsing,
