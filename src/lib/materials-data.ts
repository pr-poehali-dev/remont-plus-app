...
export const MATERIAL_SUGGESTIONS: MaterialSuggestion[] = [
  {
    ...
    variants: [
      { name: "Волма Слой", brand: "Волма", pricePerUnit: 420, unit: "мешок 30кг", coverage: "≈10 м² (1 слой)", popular: true },
      { name: "Knauf Rotband", brand: "Knauf", pricePerUnit: 648, unit: "мешок 30кг", coverage: "≈10 м² (1 слой)", popular: true },
  ...
  },
  {
    ...
    variants: [
      { name: "Волма Финиш", brand: "Волма", pricePerUnit: 360, unit: "мешок 20кг", coverage: "≈15 м² (1 слой)", popular: true },
      { name: "Knauf Fugen", brand: "Knauf", pricePerUnit: 490, unit: "мешок 25кг", coverage: "≈18 м²", popular: true },
      { name: "Ceresit CT 127", brand: "Ceresit", pricePerUnit: 590, unit: "мешок 20кг", coverage: "≈14 м²" },
  ...
  },
  {
    ...
    variants: [
      { name: "Ceresit CT 17", brand: "Ceresit", pricePerUnit: 1375, unit: "канистра 10л", coverage: "≈100 м²", popular: true },
      { name: "Knauf Tiefengrund", brand: "Knauf", pricePerUnit: 720, unit: "канистра 10л", coverage: "≈80 м²", popular: true },
      { name: "Волма Контакт", brand: "Волма", pricePerUnit: 560, unit: "канистра 10л", coverage: "≈100 м²" },
...

  {
    ...
    variants: [
      { name: "Кабель ВВГнг-LS 3×2,5мм² (50м)", brand: "Кабэкс", pricePerUnit: 6350, unit: "бухта 50м", coverage: "50 пм", popular: true },
      { name: "Кабель ВВГнг-LS 3×1,5мм² (50м)", brand: "Кабэкс", pricePerUnit: 4200, unit: "бухта 50м", coverage: "50 пм", popular: true },
      { name: "Кабель NYM 3×2,5мм² (50м)", brand: "КоЗЭл", pricePerUnit: 7500, unit: "бухта 50м", coverage: "50 пм" },
      { name: "Провод ПВС 3×2,5мм² (50м)", brand: "Гарантпроводкомплект", pricePerUnit: 5200, unit: "бухта 50м", coverage: "50 пм" },
